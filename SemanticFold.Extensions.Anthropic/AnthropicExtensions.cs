...
namespace SemanticFold.Extensions.Anthropic;

/// <summary>
/// Extension methods for converting between SemanticFold abstractions and the Anthropic messages SDK.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Converts SemanticFold messages into an Anthropic request payload, preserving order.
