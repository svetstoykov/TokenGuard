...
public static class SystemPrompt
{
    ...
    public static string Text =>
        ...
        Answer the user's question using the provided read-only tools only. Base claims on repository evidence and cite relevant file paths in backticks when they matter.
